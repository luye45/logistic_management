...
<input type="hidden" name="id" lay-verify="required" lay-reqtext="" placeholder="" value="" class="layui-input">
...
<script>
    layui.use(['form'], function () {
        ...
        form.val('editform',{
            ...
            "name":getParentValue.name,
            "spec":getParentValue.spec,
            "number":getParentValue.number,
            "price":getParentValue.price,
            "type":getParentValue.type_id,
            "producer":getParentValue.producer,
